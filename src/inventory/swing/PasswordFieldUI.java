...
public class PasswordFieldUI extends JPasswordField {
    ...
    public PasswordFieldUI() {
        ...
        eye = new ImageIcon(getClass().getResource("/inventory/icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/inventory/icon/eye_hide.png")).getImage();
