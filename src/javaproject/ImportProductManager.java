...
public class ImportProductManager extends javax.swing.JFrame {
        ...
        TypeImport.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    // Thay đổi kích thước của JFrame
                    pack();
                }
            }
        });
    ...
    private void initComponents() {
        ...
        ShortByDate.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        ShortById.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        ContainShortByIdLayout.setHorizontalGroup(
            ...
            .addGroup(ContainShortByIdLayout.createSequentialGroup()
                .addGap(355, 355, 355)
                .addComponent(CreateImportPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        ShortByCategory.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ShortByCategory.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Categoriy", "Number Import", "Import Id"
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void EditTableIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditTableIdActionPerformed
        ...
        if (row >= 0) {
            ...
            ImportEdit importDetailFrame = new ImportEdit(); // Tạo một thể hiện mới của ImportDetail (JFrame đã có sẵn)
            importDetailFrame.populateCategoriesComboBox();
            importDetailFrame.addDataById(importID); // Gọi phương thức addData để thêm dữ liệu Import IDs vào JFrame
            importDetailFrame.setVisible(true); 
        }
    ...
    private void ShortByCategoryMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ShortByCategoryMousePressed
        if (evt.getClickCount() == 2) { // Kiểm tra số lần nhấp chuột là 2
            ...
            if (row >= 0) {
                ...
                ImportDetail importDetailFrame = new ImportDetail(); // Tạo một thể hiện mới của ImportDetail (JFrame đã có sẵn)
                importDetailFrame.addDataByCategory(importIDs); // Gọi phương thức addData để thêm dữ liệu Import IDs vào JFrame
                importDetailFrame.setVisible(true); 
            }
        }
    ...
    private void CreateImportPanelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateImportPanelActionPerformed
        ...
        ImportCreate importEditFrame = new ImportCreate(); // Tạo một thể hiện mới của ImportDetail (JFrame đã có sẵn)
