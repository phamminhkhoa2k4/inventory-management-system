...
public class ImportDetail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        NewCategoryNameComboBox = new javax.swing.JComboBox<>();
        ...
        LabelCategoryName1 = new javax.swing.JLabel();
        ...
        jLabel1.setText("Edit Import Detail");
        ...
        NewCategoryNameComboBox.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        NewCategoryNameComboBox.setForeground(new java.awt.Color(0, 0, 0));
        NewCategoryNameComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        NewCategoryNameComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NewCategoryNameComboBoxActionPerformed(evt);
            }
        });
        ...
        LabelCategoryName1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        LabelCategoryName1.setText("Categories Name :");
                    ...
                    .addGroup(CreatePanelLayout.createSequentialGroup()
                        ...
                        .addGroup(CreatePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(CreatePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(CreatePanelLayout.createSequentialGroup()
                                    .addComponent(LabelCategoryName1)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(NewCategoryNameComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        CreatePanelLayout.setVerticalGroup(
            ...
            .addGroup(CreatePanelLayout.createSequentialGroup()
                ...
                .addGroup(CreatePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(LabelCategoryName1, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(NewCategoryNameComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(CreatePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void DeletePopUpMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeletePopUpMenuActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            if (rowCount > 0) {
                // Kiểm tra chỉ số hàng chọn có hợp lệ hay không
...
//            ImportEditDetail importDetailFrame = new ImportEditDetail(); // Tạo một thể hiện mới của ImportDetail (JFrame đã có sẵn)
            populateCategoriesComboBox();
            addData(importDetailID); // Gọi phương thức addData để thêm dữ liệu Import IDs vào JFrame
//            importDetailFrame.setVisible(true); // Hiển thị JFrame
        ...
        if (selectedCategory != null) {
            ...
            if (!importID.isEmpty() && !categoryName.isEmpty() && !expiry.isEmpty() && !importDetailID.isEmpty()
                ...
                if (quantity.matches("\\d+") && Integer.parseInt(quantity) > 0) {
                    // Thực hiện câu lệnh tiếp theo khi tất cả các điều kiện đúng
    ...
    private void NewCategoryNameComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NewCategoryNameComboBoxActionPerformed
    }//GEN-LAST:event_NewCategoryNameComboBoxActionPerformed
    ...
    public void populateCategoriesComboBox() {
        ...
        try {
            ...
            NewCategoryNameComboBox.removeAllItems();
            while (rs.next()) {
                String categoryName = rs.getString("Category_name");
                CategoriNameCombobox.addItem(categoryName);
                NewCategoryNameComboBox.addItem(categoryName);
            }
            //
            ...
            NewImportIdComboBox.addActionListener(e -> {
                ...
                // Gọi function hoặc thực hiện các xử lý khác dựa trên selectedImportId
    ...
    private ImageIcon resizeImageIcon(String imagePath, int width, int height) {
        try {
            ...
            // Tạo hình ảnh mới với kích thước mới nhưng cùng độ phân giải
    ...
    private javax.swing.JLabel LabelCategoryName1;
    private javax.swing.JComboBox<String> NewCategoryNameComboBox;
